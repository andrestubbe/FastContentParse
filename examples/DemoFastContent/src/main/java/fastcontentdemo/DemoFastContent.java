...
public class DemoFastContent {
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Attempting native FastContentChunk (JNI)...");
            FastContentChunkNative.Chunk[] chunks = FastContentChunkNative.chunk(doc.getText(), 12, 3);
            if (chunks != null) {
                for (FastContentChunkNative.Chunk c : chunks) {
